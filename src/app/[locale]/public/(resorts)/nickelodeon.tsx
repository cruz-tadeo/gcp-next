...
export const Nickelodeon: IResortParams = {
  ...
  paragraph: {
    ...
    text: (
      <div className="row">
        <p className="col-12">
          Guests enjoy complimentary unlimited access to this sprawling 6-acre
          themed water complex, surrounded by lush tropical gardens and over 500
          meters of adventure and lazy rivers. Features include: Adventure
          River-220m/720 ft of fast-paced water fun. Lazy River-335m/1100ft of
          winding tranquility with themed sculptures and surprises along the
        ...
        <div className="col-6">
          <p className="mt-3">
            PAW Patrol Adventure Bay with slides for the Little onesfeaturing:
          </p>
          <ul className="list-point">
            <li>
              <span className="point"></span>
        ...
        <div className="col-6 my-4">
          ...
          <div>
            Towel service, lockers($), changing rooms, restrooms and showers
          </div>
          ...
          <div>
            4 Aqua Bite serves favorites like burgers,hotdogs, pizza, and more.
          </div>
        </div>
      </div>
    ),
