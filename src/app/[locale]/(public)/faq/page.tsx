      ...
      >
        <div className="container">
            ...
            <div className="col-auto">
              <div className="setionTitle-md">
                ...
                <p>
                  ...
                  Corporis quo placeat culpa corrupti vel sed natus quod
                  tempore, odio minus quis? Libero vitae delectus, deserunt
          ...
          <div className="row justify-content-center">
            <div className="col-9">
              <h2 className="text-30 fw-500 text-exotic-dark fw-bold mb-3 ps-3">
                Reservations
              </h2>
